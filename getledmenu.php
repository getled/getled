...
function my_theme_options( $wp_customize ) {
    ...
    'getled_menu_options', 
    array(
        'title'       => __( 'GetLed Menu Settings', 'mytheme' ),
        'priority'    => 100,
        'capability'  => 'edit_theme_options',
        'description' => __('Change menu options here.', 'mytheme'), 
    ) 
);
...
$wp_customize->add_control( new WP_Customize_Color_Control( 
    ...
    array(
        'label'    => __( 'GetLed Menu Color', 'mytheme' ), 
...
$wp_customize->add_control( new WP_Customize_Color_Control( 
    ...
    array(
        'label'    => __( 'GetLed Menu background Color', 'mytheme' ), 
        'section'  => 'getled_menu_options',
...
$wp_customize->add_control( new WP_Customize_Color_Control( 
    ...
    array(
        'label'    => __( 'Menu background Color on hover', 'mytheme' ), 
        'section'  => 'getled_menu_options',
...
$wp_customize->add_control(
    'your_control_id', 
    array(
        'label'    => __( 'Menu button text', 'mytheme' ),
        'section'  => 'getled_menu_options',
...
$wp_customize->add_control(
    ...
    array(
        'label'    => __( 'Menu Icon (fontawesome class)', 'mytheme' ),
        'section'  => 'getled_menu_options',
