    ...
    var EZP = {
        init: function (options, elem) {
            ...
            if (self.options.loadingIcon && !self.spinner) {
                self.spinner = $('<div class="sviLoader" style="position: absolute; left: 0; top:0px"></div>');

                self.$elem.after(self.spinner);

                $("div#woosvimain .swiper-slide-active img, div#woosvimain>img").fadeTo('fast', 0.5);
                self.spinner.show();
        ...
        fetch: function (imgsrc, element, minZoom) {
            ...
            newImg.onload = function () {
                ...
                if (self.options.loadingIcon && !!self.spinner && !!self.spinner.length) {
                    //self.spinner.hide();
                    $("div#woosvimain .swiper-slide-active img, div#woosvimain>img").fadeTo('fast', 1, function () {
                        self.spinner.remove();
                    });
                }
            };
        ...
        startZoom: function () {
            ...
            self.zoomContainer =
                    $('<div class="' + self.options.container + '" ' +
